...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.dsarena.corp.gateway.msv.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.dsarena.corp.gateway.msv.security.DomainUserDetailsService", "createSpringSecurityUser");
