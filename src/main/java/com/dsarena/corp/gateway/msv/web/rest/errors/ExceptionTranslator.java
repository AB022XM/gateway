...
public class ExceptionTranslator extends ResponseEntityExceptionHandler implements ExceptionTranslation {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.dsarena.corp.gateway.msv.service.EmailAlreadyUsedException ||
            ex instanceof com.dsarena.corp.gateway.msv.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.dsarena.corp.gateway.msv.service.InvalidPasswordException
